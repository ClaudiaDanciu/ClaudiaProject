...
namespace ClaudiaProject.Data.Migrations
{
    ...
    [Migration("20221120214926_ComplexDataModel")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClaudiaProject.Models.Course", b =>
                {
            ...
            modelBuilder.Entity("ClaudiaProject.Models.Instructor", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ClaudiaProject.Models.Course", b =>
                {
                    b.HasOne("ClaudiaProject.Models.Department", "Department")
                        .WithMany("Courses")
            ...
            modelBuilder.Entity("ClaudiaProject.Models.Department", b =>
                {
                    b.HasOne("ClaudiaProject.Models.Instructor", "Administrator")
                        .WithMany()
                        .HasForeignKey("InstructorID");
            ...
            modelBuilder.Entity("ClaudiaProject.Models.Enrollment", b =>
                {
                    ...
                    b.HasOne("ClaudiaProject.Models.Student", "Student")
                        .WithMany("Enrollments")
            ...
            modelBuilder.Entity("ClaudiaProject.Models.OfficeAssignement", b =>
                {
                    b.HasOne("ClaudiaProject.Models.Instructor", "Instructor")
                        ...
                        .HasForeignKey("ClaudiaProject.Models.OfficeAssignement", "InstructorID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CourseInstructor", b =>
                {
                    b.HasOne("ClaudiaProject.Models.Course", null)
                        .WithMany()
                        .HasForeignKey("CoursesCourseID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ClaudiaProject.Models.Instructor", null)
                        .WithMany()
